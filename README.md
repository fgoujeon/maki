...
<
    ...
    fgfsm::row<off,            push,  emitting_white, turn_light_white>,
    fgfsm::row<emitting_white, push,  emitting_red,   turn_light_red,    is_short_push>,
    fgfsm::row<emitting_red,   push,  emitting_green, turn_light_green,  is_short_push>,
    fgfsm::row<emitting_green, push,  emitting_blue,  turn_light_blue,   is_short_push>,
    fgfsm::row<emitting_blue,  push,  emitting_white, turn_light_white,  is_short_push>,
    fgfsm::row<fgfsm::any,     push,  off,            turn_light_off,    is_long_push>
>;
```
