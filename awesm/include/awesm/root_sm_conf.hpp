...
struct root_sm_conf_tpl
{
    using after_state_transition = root_sm_conf_tpl<Options..., root_sm_opts::after_state_transition>;

    using no_auto_start = root_sm_conf_tpl<Options..., root_sm_opts::no_auto_start>;

    using before_entry = root_sm_conf_tpl<Options..., root_sm_opts::before_entry>;

    using before_state_transition = root_sm_conf_tpl<Options..., root_sm_opts::before_state_transition>;

    template<class T>
    using context = root_sm_conf_tpl<Options..., root_sm_opts::context<T>>;

    using no_run_to_completion = root_sm_conf_tpl<Options..., root_sm_opts::no_run_to_completion>;

    using get_pretty_name = root_sm_conf_tpl<Options..., root_sm_opts::get_pretty_name>;

    using on_exception = root_sm_conf_tpl<Options..., root_sm_opts::on_exception>;

    using on_unprocessed = root_sm_conf_tpl<Options..., root_sm_opts::on_unprocessed>;

    template<std::size_t Value>
    using small_event_max_align = root_sm_conf_tpl<Options..., root_sm_opts::small_event_max_align<Value>>;

    template<std::size_t Value>
    using small_event_max_size = root_sm_conf_tpl<Options..., root_sm_opts::small_event_max_size<Value>>;

    template<class... EventFilters>
    using on_event = root_sm_conf_tpl<Options..., root_sm_opts::on_event<EventFilters...>>;

    using on_event_auto = root_sm_conf_tpl<Options..., root_sm_opts::on_event_auto>;

    template<bool Enable = true>
    using on_entry = root_sm_conf_tpl<Options..., root_sm_opts::on_entry<Enable>>;

    template<bool Enable = true>
    using on_exit = root_sm_conf_tpl<Options..., root_sm_opts::on_exit<Enable>>;

    template<class... Ts>
    using transition_tables = root_sm_conf_tpl<Options..., root_sm_opts::transition_tables<Ts...>>;

    static constexpr auto is_root = true;
};

using root_sm_conf = root_sm_conf_tpl<>;
...
namespace detail
{
    ...
    template<class... Options>
    struct is_root_sm_conf<root_sm_conf_tpl<Options...>>
    {
