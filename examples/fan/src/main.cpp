...
constexpr auto transition_table = maki::transition_table{}
    ...
    (reading_memory, maki::type_c<memory_read>,        spinning_low,  maki::null_c, is_speed_low)
    (reading_memory, maki::type_c<memory_read>,        spinning_med,  maki::null_c, is_speed_med)
    (reading_memory, maki::type_c<memory_read>,        spinning_high, maki::null_c, is_speed_high)
    (spinning_low,   maki::type_c<plus_button_press>,  spinning_med,  maki::null_c)
    (spinning_med,   maki::type_c<plus_button_press>,  spinning_high, maki::null_c)
    (spinning_med,   maki::type_c<minus_button_press>, spinning_low,  maki::null_c)
    (spinning_high,  maki::type_c<minus_button_press>, spinning_med,  maki::null_c)
;
//! [transition-table]
