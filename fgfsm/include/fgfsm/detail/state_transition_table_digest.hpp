...
#ifndef FGFSM_DETAIL_STATE_TRANSITION_TABLE_DIGEST_HPP
#define FGFSM_DETAIL_STATE_TRANSITION_TABLE_DIGEST_HPP
...
types of a given state_transition_table.
...
namespace state_transition_table_digest_detail
{
...
struct state_transition_table_digest;

template<class... Rows>
struct state_transition_table_digest<state_transition_table<Rows...>>:
    state_transition_table_digest_detail::helper
    <
        std::tuple<>,
        std::tuple<>,
        std::tuple<>,
