...
namespace transition_table_digest_detail
{
    ...
    {
    private:
        static constexpr const auto& initial_state_conf = tlu::get_t<TransitionConstantList, 0>::value.source_state_conf_pattern;
    ...
    struct add_transition_to_digest
    {
        ...
        <
            ...
            TransitionConstant::value.target_state_conf
        >;
