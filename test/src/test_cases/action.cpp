...
namespace
{
    ...
    struct actions
    {
        struct beep
        {
            void operator()(const states::off&, const events::button_press&, const states::on&) const
            {
                ctx.i = 1;
            }

            void operator()(const states::on&, const events::button_press&, const states::off&) const
            {
                ctx.i = 0;
            }
