...
#undef GUARD
    ...
    <
        awesm::row<states::idle, events::start, states::state0, void, guards::can_access_state0>,
        awesm::row<states::idle, events::start, states::state1, void, guards::can_access_state1>,
        awesm::row<states::idle, events::start, states::state2, void, guards::can_access_state2>,
        awesm::row<states::idle, events::start, states::state3, void, guards::can_access_state3>,
