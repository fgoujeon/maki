...
namespace
{
    ...
    struct fsm_configuration: fgfsm::fsm_configuration
    {
        ...
        static auto make_transition_table()
        {
            ...
            {
                fgfsm::make_row<states::state0, events::next_state, states::state1>(),
                fgfsm::make_row<states::state1, events::next_state, states::state2>(),
                fgfsm::make_row<states::state2, events::next_state, states::state3>(),
                fgfsm::make_row<states::state3, events::next_state, states::state4>(),
                fgfsm::make_row<states::state4, events::next_state, states::state5>(),
                fgfsm::make_row<states::state5, events::next_state, states::state6>(),
                fgfsm::make_row<states::state6, events::next_state, states::state7>(),
                fgfsm::make_row<states::state7, events::next_state, states::state8>(),
                fgfsm::make_row<states::state8, events::next_state, states::state9>(),
                fgfsm::make_row<states::state9, events::next_state, states::benchmarking>()
            };
        }
