    ...
    namespace states
    {
        ...
        namespace on_ns
        {
            ...
            struct emitting_red
            {
                ...
                <
                    awesm::sm_opts::transition_tables<emitting_red_ns::sm_transition_table>,
        ...
        struct on
        {
            using conf = awesm::sm_conf
            <
                awesm::sm_opts::transition_tables<on_ns::sm_transition_table>,
                awesm::sm_opts::context<on_ns::context>,
