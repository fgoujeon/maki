...
namespace AOS(guard_operators_ns)
{
    struct context
    {
...
#undef GUARD
    ...
    AOS_TEST_CASE("guard_operators")
    {
        ...
        SECTION("and")
        {
            AOS_CALL machine.AOS(process_event)(events::stop{});
            ctx.can_access_state0_0 = false;
            ctx.can_access_state0_1 = false;
            AOS_CALL machine.AOS(process_event)(events::start{});
