...
{
    {
        ...
        REQUIRE(maki::to_string(maki::constant<&path>) == "main_sm/0");
    }

    {
        static constexpr auto path = maki::path{machine_conf} / 1;
        REQUIRE(maki::to_string(maki::constant<&path>) == "main_sm/1");
    }

    {
        static constexpr auto path = maki::path{machine_conf} / 1 / states::on1 / 0;
        REQUIRE(maki::to_string(maki::constant<&path>) == "main_sm/1/on_1/0");
    }
}
