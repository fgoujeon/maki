...
namespace
{
    ...
    constexpr auto transition_table = maki::transition_table{}
        (state, maki::type<event_processing_request<small_event>>, maki::null_c, process_event<small_event>)
        (state, maki::type<event_processing_request<big_event>>,   maki::null_c, process_event<big_event>)
    ;
